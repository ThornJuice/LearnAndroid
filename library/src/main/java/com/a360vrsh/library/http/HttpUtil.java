...
public class HttpUtil {
    ...
    public static void get(Context context, String url, HashMap<String, String> paramMap, HttpListener httpListener, boolean showLoading) {
        ...
        RxHttp.get(url)
                ...
                .subscribe(new Consumer<String>() {
                    @Override
                    public void accept(String resonse) {//网络请求成功
                        handleSuccess(context, resonse, httpListener);
                    }
                }, new OnError() {
                    @Override
                    public void onError(ErrorInfo errorInfo) {//网络请求失败
     ...
     * @param showLoading
     */
    public static void get(Context context, String url, Map<String, String> paramMap, HttpListener httpListener, boolean showLoading) {
     ...
     * @param showLoading
     */
    public static void upLoadWithProgress(Context context, String type, File file, HttpListener httpListener, boolean showLoading) {
        ...
        RxHttp.postForm(UrlConstant.UPLOAD)
                ...
                .upload(AndroidSchedulers.mainThread(), progress -> {
                    ...
                    LogUtil.e("upload......", "currentProgress....:" + currentProgress+"%");
                    LogUtil.e("upload......", "currentSize:" + currentSize);
                    LogUtil.e("upload......", "totalSize:" + totalSize);
                })
                .asString()
                .doFinally(() -> {
                    if (showLoading) {
