 ...
 * @description:
 */
public class MyTagFlowLayout extends FlowLayout
        implements MyFlowLayoutTagAdapter.OnDataChangedListener {

    private MyFlowLayoutTagAdapter mTagAdapter;
    ...
    public void setAdapter(MyFlowLayoutTagAdapter adapter) {
        mTagAdapter = adapter;
    ...
    private void changeAdapter() {
        removeAllViews();
        MyFlowLayoutTagAdapter adapter = mTagAdapter;
...
//            mSelectedView.remove(position);
    ...
    public MyFlowLayoutTagAdapter getAdapter() {
        return mTagAdapter;
    }
